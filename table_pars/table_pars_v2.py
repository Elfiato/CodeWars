...
'''
Программа считает и приводит к удобному для составления СЗ на закупку виду перечни элементов.

Формат входных данных - файл формата txt, полученный путем копирования таблиц из перечня элементов ворда и
вствки их в эксель, с последующим сохранением в виде "Текстовые файлы с разделителями табуляции .txt".
...
name_base_file = 'full_per_test.txt'
name_write_file = 'full_out_test.csv'
